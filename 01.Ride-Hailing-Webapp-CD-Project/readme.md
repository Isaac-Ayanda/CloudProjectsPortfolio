...
+ We also use dynamoDB, a Key-value ("NoSQL") database. User request a ride that will select a unicorn from the fleet and record that request in the dynamoDB table
